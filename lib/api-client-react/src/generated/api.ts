...
export const getGetObjectEntityUrl = (objectPath: string,) => {
 ...
 */
export const getObjectEntity = async (objectPath: string, options?: RequestInit): Promise<Blob> => {

  return customFetch<Blob>(getGetObjectEntityUrl(objectPath),
  {
    ...options,
    method: 'GET'
...
export const getGetObjectEntityQueryKey = (objectPath: string,) => {
    return [
...
export const getGetObjectEntityQueryOptions = <TData = Awaited<ReturnType<typeof getObjectEntity>>, TError = ErrorType<ErrorEnvelope>>(objectPath: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getObjectEntity>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetObjectEntityQueryKey(objectPath);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getObjectEntity>>> = ({ signal }) => getObjectEntity(objectPath, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: !!(objectPath), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getObjectEntity>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetObjectEntity<TData = Awaited<ReturnType<typeof getObjectEntity>>, TError = ErrorType<ErrorEnvelope>>(
 objectPath: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getObjectEntity>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetObjectEntityQueryOptions(objectPath,options)

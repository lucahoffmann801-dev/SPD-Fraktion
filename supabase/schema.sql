-- SPD-Fraktion KL Portal – Supabase schema
...
-- Für den ersten internen Prototyp: Zugriff über den anon key erlauben.
-- Später bitte durch Supabase Auth + Rollen ersetzen.

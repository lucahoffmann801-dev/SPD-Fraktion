...
const allowed = new Set(["events", "tasks", "members", "documents", "calendar_sources"]);
...
export async function PATCH(request: NextRequest) {
  try {
    const body = await request.json();
    if (!validTable(body.table) || typeof body.id !== "string") {

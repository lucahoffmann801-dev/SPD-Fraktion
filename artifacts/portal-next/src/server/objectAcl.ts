...
export async function canAccessObject({ userId, objectFile, requestedPermission }: { userId?: string; objectFile: File; requestedPermission: ObjectPermission }): Promise<boolean> {

...
const demoDocs = [{ id: "d-1", title: "Anträge und Vorlagen", category: "Arbeitsordner", url: null, description: "Arbeitsstände, Vorlagen und Entwürfe der Fraktion.", owner: "Luca Hoffmann", document_date: null, status: "arbeitsstand", kind: "Arbeitsordner" }];
const demoSources = [{ id: "s-1", name: "RIS Kaiserslautern", type: "ics", url: "https://ris.kaiserslautern.de", owner: "Fraktion", enabled: true, last_synced_at: null, notes: null }];
...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      profiles: demoProfiles, events: mergeVisibleEvents(demoEvents), tasks: demoTasks,
      members: [], documents: [], calendar_sources: [], sync_logs: [], cases: [],

...
function KanbanBoard({ tasks, profile, onStatus, onProgress, compact = false }: { tasks: FraktionTask[]; profile: FraktionProfile; onStatus: (task: FraktionTask, status: string) => Promise<void>; onProgress: (task: FraktionTask, progress: number) => Promise<void>; compact?: boolean }) {
...
function KanbanCard({ task, onStatus }: { task: FraktionTask; profile: FraktionProfile; onStatus: (task: FraktionTask, status: string) => Promise<void>; onProgress: (task: FraktionTask, progress: number) => Promise<void> }) {
